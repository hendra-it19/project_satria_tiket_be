...
@section('pages')
    <div class="row">
        <div class="col-12 my-3">
            <p><a href="{{ route('ships.index') }}">Kapal > </a> Ubah Data</p>
            <h3 class="text-primary">Ubah Data Kapal</h3>
        </div>

        <div class="col-12">
            <form action="{{ route('ships.update', $ship->id) }}" method="post" class="row">
                @csrf
                @method('put')
                ...
                <div class="mb-3 col-12 col-md-5">
                    ...
                    <input type="text" id="nama_kapal" name="nama_kapal"
                        ...
                        is-invalid
                    @enderror"
                        value="{{ old('nama_kapal', $ship->nama_kapal) }}">
                    @error('nama_kapal')
                ...
                <div class="mb-3 col-12 col-md-5">
                    ...
                    <input type="number" id="kapasitas_penumpang" name="kapasitas_penumpang"
                        ...
                        is-invalid
                    @enderror"
                        value="{{ old('kapasitas_penumpang', $ship->kapasitas_penumpang) }}">
                ...
                <div class="mb-3 col-12 col-md-5">
                    ...
                    <input type="number" id="panjang_kapal" name="panjang_kapal"
                        ...
                        is-invalid
                    @enderror"
                        value="{{ old('panjang_kapal', $ship->panjang_kapal) }}">
                    @error('panjang_kapal')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3 col-12 col-md-5">
                    ...
                    <input type="number" id="lebar_kapal" name="lebar_kapal"
                        ...
                        is-invalid
                    @enderror"
                        value="{{ old('lebar_kapal', $ship->lebar_kapal) }}">
                    @error('lebar_kapal')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3 col-12 col-md-5">
                    ...
                    <input type="number" id="tahun_produksi" name="tahun_produksi"
                        ...
                        is-invalid
                    @enderror"
                        value="{{ old('tahun_produksi', $ship->tahun_produksi) }}">
